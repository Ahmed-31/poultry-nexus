    ...
    : void
    {
        ...
        DB::table('products')->insert([
            [
                ...
                'description'    => 'Distributes feed efficiently to poultry.',
                'price'          => 500.00,
                'stock_quantity' => 30,
                'sku'            => 'FEED-001',
                'category_id'    => DB::table('categories')->where('name', 'Feeding Systems')->first()->id,
                'created_at'     => Carbon::now(),
                'updated_at'     => Carbon::now(),
            ],
            [
                'name'           => 'Nipple Drinker System',
                'description'    => 'Provides clean drinking water for poultry.',
                'price'          => 150.00,
                'stock_quantity' => 100,
                'sku'            => 'DRINK-001',
                'category_id'    => DB::table('categories')->where('name', 'Drinking Systems')->first()->id,
                'created_at'     => Carbon::now(),
                'updated_at'     => Carbon::now(),
            ],
            [
                'name'           => 'Ventilation Fan',
                'description'    => 'Ensures proper air circulation in poultry houses.',
                'price'          => 300.00,
                'stock_quantity' => 20,
                'sku'            => 'CLIMATE-001',
                'category_id'    => DB::table('categories')->where('name', 'Climate Control')->first()->id,
                'created_at'     => Carbon::now(),
                'updated_at'     => Carbon::now(),
            ],
        ]);
        ...
        DB::table('inventory')->insert([
            [
                'product_id'          => DB::table('products')->where('name', 'Automatic Feed Dispenser')->first()->id,
                'warehouse_id'        => DB::table('warehouses')->where('name', 'Main Warehouse')->first()->id,
                'quantity'            => 28,
            ...
            [
                'product_id'          => DB::table('products')->where('name', 'Nipple Drinker System')->first()->id,
                'warehouse_id'        => DB::table('warehouses')->where('name', 'Regional Distribution Center')->first()->id,
                'quantity'            => 97,
            ...
            [
                'product_id'          => DB::table('products')->where('name', 'Ventilation Fan')->first()->id,
                'warehouse_id'        => DB::table('warehouses')->where('name', 'Overflow Storage')->first()->id,
                'quantity'            => 18,
        ...
        DB::table('shipment_items')->insert([
            [
                ...
                'product_id'    => DB::table('products')->where('name', 'Automatic Feed Dispenser')->first()->id,
                'order_item_id' => DB::table('order_items')->where('product_id', DB::table('products')->where('name', 'Automatic Feed Dispenser')->first()->id)->first()->id,
                'inventory_id'  => DB::table('inventory')->where('product_id', DB::table('products')->where('name', 'Automatic Feed Dispenser')->first()->id)->first()->id,
                'quantity'      => 2,
                'created_at'    => Carbon::now(),
                'updated_at'    => Carbon::now(),
            ],
            [
                ...
                'product_id'    => DB::table('products')->where('name', 'Nipple Drinker System')->first()->id,
                'order_item_id' => DB::table('order_items')->where('product_id', DB::table('products')->where('name', 'Nipple Drinker System')->first()->id)->first()->id,
                'inventory_id'  => DB::table('inventory')->where('product_id', DB::table('products')->where('name', 'Nipple Drinker System')->first()->id)->first()->id,
                'quantity'      => 3,
                'created_at'    => Carbon::now(),
                'updated_at'    => Carbon::now(),
            ],
            [
                ...
                'product_id'    => DB::table('products')->where('name', 'Ventilation Fan')->first()->id,
                'order_item_id' => DB::table('order_items')->where('product_id', DB::table('products')->where('name', 'Ventilation Fan')->first()->id)->first()->id,
                'inventory_id'  => DB::table('inventory')->where('product_id', DB::table('products')->where('name', 'Ventilation Fan')->first()->id)->first()->id,
                'quantity'      => 2,
                'created_at'    => Carbon::now(),
                'updated_at'    => Carbon::now(),
            ],
        ...
        DB::table('inventory_transactions')->insert([
            [
                ...
                'notes'            => 'Stocked from purchase PUR-1001.',
                'created_at'       => Carbon::now(),
                'updated_at'       => Carbon::now(),
            ],
            [
                ...
                'notes'            => 'Stocked from purchase PUR-1002.',
                'created_at'       => Carbon::now(),
                'updated_at'       => Carbon::now(),
            ],
            [
                ...
                'notes'            => 'Stocked from purchase PUR-1003.',
                'created_at'       => Carbon::now(),
                'updated_at'       => Carbon::now(),
            ],
        ]);
